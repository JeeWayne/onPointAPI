...
class VendrAPIV1 {
    ...
    constructor(APIKey, HubId){
        console.warn("WARNING: This version of the Vendr API is deprecated, meaning it can no longer be used. Please use the latest version of the Vendr API.")
        this.APIKey = APIKey;
        this.HubId = HubId;
    }
